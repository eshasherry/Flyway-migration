...
VALUES
    ('ttc_api_gateway','transform_jobquestions','integration',0,'',NOW(),'ttc_verify','ttc_verify',NOW(),'ttc_verify','ttc_verify');
...
VALUES
    ('ttc_api_gateway','transform_jobquestions','','','en','Job Question Submission Service','','','',NOW(),'ttc_verify','ttc_verify',NOW(),'ttc_verify','ttc_verify');
...
VALUES
    ('ttc_api_gateway_api','ttc_api_gateway','transform_jobquestions','','',0,1,1,200,300,now(),'ttc_verify','ttc_verify',now(),'ttc_verify','ttc_verify',-1,-1,5,2);
