...
BEGIN
    ...
    IF var_count = 1 THEN
        ...
        VALUES ('peoplesofthcm', 'position_import', 'integration', '0', NOW(), 'ttc_verify', 'ttc_verify', NOW(), 'ttc_verify', 'ttc_verify');
        ...
        VALUES ('peoplesofthcm', 'position_import', '', '', 'en', 'Position Import (PSFT to JV)', '', '', '', NOW(), 'ttc_verify', 'ttc_verify', NOW(), 'ttc_verify', 'ttc_verify');
		...
		VALUES
            ('peoplesofthcm_api','peoplesofthcm','position_import','','',0,1,1,0,0,now(),'ttc_verify','ttc_verify',now(),'ttc_verify','ttc_verify',-1,-1,0,1);
