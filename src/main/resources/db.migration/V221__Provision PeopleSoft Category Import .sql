...
BEGIN
    ...
    IF var_count = 1 THEN
        ...
        VALUES ('peoplesofthcm', 'category_import', 'integration', '0', NOW(), 'ttc_verify', 'ttc_verify', NOW(), 'ttc_verify', 'ttc_verify');
        ...
        VALUES ('peoplesofthcm', 'category_import', '', '', 'en', 'Category Import (PSFT to JV)', '', '', '', NOW(), 'ttc_verify', 'ttc_verify', NOW(), 'ttc_verify', 'ttc_verify');
	    ...
	    VALUES
            ('peoplesofthcm_api','peoplesofthcm','category_import','','',0,1,1,0,0,now(),'ttc_verify','ttc_verify',now(),'ttc_verify','ttc_verify',-1,-1,0,1);
