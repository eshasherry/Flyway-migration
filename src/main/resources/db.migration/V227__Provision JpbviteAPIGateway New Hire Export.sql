DELIMITER //
CREATE PROCEDURE provision_jobviteapigateway_temp_227()
BEGIN
    ...
    IF var_count = 1 THEN
        ...
        VALUES ('jobviteapigateway', 'new_hire_export', 'integration', '0', NOW(), 'ttc_verify', 'ttc_verify', NOW(), 'ttc_verify', 'ttc_verify');
        ...
        VALUES ('jobviteapigateway', 'new_hire_export', '', '', 'en', 'New Hire Export', '', '', '', NOW(), 'ttc_verify', 'ttc_verify', NOW(), 'ttc_verify', 'ttc_verify');
        ...
        VALUES
            ('jobviteapigateway_api','jobviteapigateway','new_hire_export','','',0,1,1,0,0,now(),'ttc_verify','ttc_verify',now(),'ttc_verify','ttc_verify',-1,-1,0,1);
            
    END IF;
END//
DELIMITER ;

CALL provision_jobviteapigateway_temp_227();
DROP PROCEDURE provision_jobviteapigateway_temp_227;